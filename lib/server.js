...
var EDITOR = {username: process.env.COBERTURA_EDITOR_USERNAME, password: process.env.COBERTURA_EDITOR_PASSWORD};
var COLLABORATOR = {username: process.env.COBERTURA_COLLABORATOR_USERNAME, password: process.env.COBERTURA_COLLABORATOR_PASSWORD};
...
exports.startServer = function() {
    ...
    router.delete('/buzzes/:id', simpleAuth([EDITOR]), function(req, res) {
      buzzesRepository.deleteById(req.params.id, function(result) {
        res.statusCode = 204;
        res.end();
      });
    });
